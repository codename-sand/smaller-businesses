$(document).ready(function() {
    ...
    // 리스트 생성
    $("ul.logo_list01").append(repeat_string(htmlList, totalImgNum));
    ...
    $("ul.logo_list01 li").each(function(){
        ...
        if(imgNumber < 10){
            imgSrc= "img/2017_business/business0" + imgNumber + ".gif"
        }else{
            imgSrc= "img/2017_business/business" + imgNumber + ".gif"
...
$(window).scroll(function () {
    ...
    // var selected_company = $("#selected_company").offset().top;
